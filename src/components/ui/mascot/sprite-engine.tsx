...
// Código proporcionado por https://ignaciofigueroa.dev/ (gracias, bro!)
...
export const SPRITE_HAIR = {
  crop: 'M6 2h12v1H6ZM4 3h16v2H4ZM4 5h2v3H4ZM18 5h2v3H18ZM7 5h3v1H7ZM14 5h2v1H14Z',
...
function Sprite({
  ...
  return (
    <svg
      ...
      className={`sprite sprite-${state} ${className || ""}`.trim()}
